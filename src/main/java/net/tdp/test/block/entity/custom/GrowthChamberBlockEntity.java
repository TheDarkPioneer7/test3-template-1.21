package net.tdp.test.block.entity.custom;


import net.fabricmc.fabric.api.screenhandler.v1.ExtendedScreenHandlerFactory;
import net.minecraft.recipe.RecipeEntry;
import net.tdp.test.block.entity.ImplementedInventory;
import net.tdp.test.block.entity.ModBlockEntities;
import net.tdp.test.recipe.GrowthChamberRecipe;
import net.tdp.test.recipe.GrowthChamberRecipeInput;
...
public class GrowthChamberBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory<BlockPos>, ImplementedInventory {
    ...
    public Text getDisplayName() {
        return Text.translatable("block.test.growth_chamber");
    }
    ...
    private Optional<RecipeEntry<GrowthChamberRecipe>> getCurrentRecipe() {
        Optional<RecipeEntry<GrowthChamberRecipe>> recipe = this.getWorld().getRecipeManager()
